...
<body>
    ...
    <ul class="product-details">
        ...
        <li><strong>Размер экрана:</strong> <?= $product['display_size'] ?> дюймов</li>
        <li><strong>Разрешение экрана:</strong> <?= $product['display_resolution'] ?> пикселей</li>
        <li><strong>Процессор:</strong> <?= $product['processor'] ?></li>
        <li><strong>ОЗУ:</strong> <?= $product['ram'] ?> ГБ</li>
        <li><strong>Память:</strong> <?= $product['storage'] ?> ГБ</li>
        <li><strong>Ёмкость аккумулятора:</strong> <?= $product['battery_capacity'] ?> mAh</li>
        <br><br>
